...
\newcommand{\warning}{\textcolor{red}}
...
%\subsection{Summary}
%\warning{Other results mentioned in Handbook of Macro}
%\begin{itemize}
%    \item Households save to smooth consumption despite variation in income over time (in the life cycle model, households accumulate wealth to maintain smooth consumption in retirement)
%\end{itemize}
